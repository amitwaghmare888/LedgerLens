...
import { ArcCurve } from "@/lib/globe/arc.class";
import { latLongToVector3 } from "@/lib/globe/map";

import { TargetMarker } from "./target-marker";
import { AnimatedPath } from "@/lib/globe/types";
...
const Arc = ({
  ...
  const arcPath = useMemo(() => 
    animationStage === "hide" ? [end, start] : [start, end],
    [animationStage, start, end]
  );
  ...
  }, [arcPath, radius, arcHeightFactor, arcHeightOffset]);
