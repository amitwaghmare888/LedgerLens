...
import { DotLatLon } from "@/lib/globe/types";
import { loadImage } from "@/lib/globe/load-image";
...
const Dots = ({
  ...
  const uniforms = useMemo(
    () => ({
      ...
      twinkleStrength: { value: twinkleStrength },
    }),
    [dotColor, twinkleStrength]
  );
  ...
  useEffect(() => {
    ...
    async function loadDots() {
      try {
        const imageData = await loadImage("/globe/world_alpha_mini.jpg");
